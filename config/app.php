...
return [
    ...
    'Cache' => [
         ...
         */
        // Kept for backwards compatibility with plugins that use _cake_core_
        '_cake_core_' => [
            'className' => FileEngine::class,
        ...
        // CakePHP 5.1+ renamed _cake_core_ to _cake_translations_
        '_cake_translations_' => [
            'className' => FileEngine::class,
     ...
     */
    'Error' => [
        // Suppress E_USER_DEPRECATED to prevent deprecation warnings from
        // outputting early and blocking Set-Cookie / CSRF headers
